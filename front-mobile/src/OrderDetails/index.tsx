...
function OrderDetails({ route}: Props) {
  ...
  const handleConfirmaDelivery = () => {
      confirmDelivery(order.id)
        ...
        .catch( () => {
            Alert.alert(`Houver um erro ao confirmar o Pedido ${order.id} !` );
        })
  ...
  return (
      ...
      <View style={styles.container}>
            ...
            <RectButton style={styles.button}> 
                <Text style={styles.buttonText} onPress={handleConfirmaDelivery}>CONFIRMAR ENTREGA</Text>
            </RectButton>
